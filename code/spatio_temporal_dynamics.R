...
png(filename = paste0(outDir,"/Jan.png"),width=1100,height=1100,units='px',pointsize=35)
trial=ggplot()+geom_point(data=full_no_zero, aes(x=total,y=cv,color=species))
trial=trial+xlab("Magnitude of threat")+ylab("Variability of bycatch threat")+ggtitle("Management implications of the spatio-temporal dynamics of January interactions")
trial
dev.off()
